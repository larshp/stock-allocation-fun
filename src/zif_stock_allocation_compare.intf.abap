INTERFACE zif_stock_allocation_compare PUBLIC.
  ...
  TYPES:
    BEGIN OF ty_change,
      ...
      old_reservation_id            TYPE zif_stock_allocation=>ty_reservation_id,
      new_reservation_id            TYPE zif_stock_allocation=>ty_reservation_id,
  ...
  TYPES:
    BEGIN OF ty_reconciliation,
      ...
      snapshot_full_mix_pct        TYPE zif_allocation_audit=>ty_coverage,
      snapshot_partial_mix_pct     TYPE zif_allocation_audit=>ty_coverage,
      snapshot_unallocated_mix_pct TYPE zif_allocation_audit=>ty_coverage,
  ...
  TYPES:
    BEGIN OF ty_summary,
      ...
      status_changed_rows          TYPE i,
      status_improved_rows         TYPE i,
      status_regressed_rows        TYPE i,
      status_changed_mix_pct       TYPE zif_allocation_audit=>ty_coverage,
      status_improved_mix_pct      TYPE zif_allocation_audit=>ty_coverage,
      status_regressed_mix_pct     TYPE zif_allocation_audit=>ty_coverage,

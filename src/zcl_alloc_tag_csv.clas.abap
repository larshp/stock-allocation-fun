CLASS zcl_alloc_tag_csv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_alloc_tag_csv IMPLEMENTATION.
  ...
  METHOD build.
    ...
    APPEND 'TAG' TO lt_fields.
    lv_line = mo_csv->build_line( lt_fields ).
    APPEND lv_line TO rt_lines.

    LOOP AT it_tags INTO DATA(ls_tag).
      CLEAR lt_fields.
      APPEND |{ ls_tag-run_id }| TO lt_fields.
      APPEND |{ ls_tag-tag }| TO lt_fields.

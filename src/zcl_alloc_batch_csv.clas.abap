CLASS zcl_alloc_batch_csv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_alloc_batch_csv IMPLEMENTATION.
  ...
  METHOD build.
    ...
    LOOP AT it_lines INTO DATA(ls_batch).
      CLEAR lt_fields.
      APPEND |{ ls_batch-batch }| TO lt_fields.
      APPEND |{ ls_batch-matnr }| TO lt_fields.
      APPEND |{ ls_batch-quantity }| TO lt_fields.

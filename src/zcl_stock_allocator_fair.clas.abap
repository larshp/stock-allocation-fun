CLASS zcl_stock_allocator_fair DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS zcl_stock_allocator_fair IMPLEMENTATION.
  METHOD zif_stock_allocation~allocate.
    ...
    WHILE rv_remaining > 0.
      CLEAR: lv_active_count, lv_progress.
      LOOP AT ct_demands ASSIGNING <ls_demand>.
      ...
      lv_share = rv_remaining / lv_active_count.
      IF lv_share <= 0.
        EXIT.
      ENDIF.
      LOOP AT ct_demands ASSIGNING <ls_demand>.

CLASS zcl_alloc_hist_csv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_alloc_hist_csv IMPLEMENTATION.
  ...
  METHOD build.
    ...
    APPEND 'BUCKET_FROM' TO lt_fields.
    APPEND 'BUCKET_TO' TO lt_fields.
    ...
    LOOP AT it_lines INTO DATA(ls_bucket).
      CLEAR lt_fields.
      APPEND |{ ls_bucket-bucket_from }| TO lt_fields.
      APPEND |{ ls_bucket-bucket_to }| TO lt_fields.
      APPEND |{ ls_bucket-count }| TO lt_fields.
      APPEND |{ ls_bucket-quantity }| TO lt_fields.

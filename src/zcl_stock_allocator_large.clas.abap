CLASS zcl_stock_allocator_large DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  PUBLIC SECTION.
...
CLASS zcl_stock_allocator_large IMPLEMENTATION.
  METHOD zif_stock_allocation~allocate.
    ...
    SORT ct_demands BY requested DESCENDING priority DESCENDING
                       requested_on ASCENDING order_id ASCENDING.

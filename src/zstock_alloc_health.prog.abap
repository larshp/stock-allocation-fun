...
START-OF-SELECTION.
  ...
  TRY.
      ...
      ls_health = zcl_stock_allocation_health=>evaluate(
        ...
        iv_require_last_comp_success   = p_csucc
        iv_min_last_comp_succ_streak   = p_cstrk
        iv_max_last_comp_fail_streak   = p_cfail
        ...
        iv_max_last_comp_shortage_pct  = p_cspct
        iv_max_last_comp_shortage_qty  = p_cshmax
        iv_min_last_comp_allocated     = p_camin
        iv_min_last_comp_requested     = p_crqmin
        iv_max_last_comp_requested     = p_crqmax
        iv_max_last_comp_allocated     = p_caqmax
        iv_min_last_comp_avail_stock   = p_cavmin
        iv_max_last_comp_avail_stock   = p_cavmax
        iv_min_last_comp_full_ln_rate  = p_cflmin
        iv_max_last_comp_full_ln_rate  = p_cflmax
        iv_max_last_comp_unalloc_rate  = p_culmax
        iv_max_last_comp_partial_rate  = p_cplmax
        iv_min_last_comp_full_ln_count = p_cflcnt
        iv_min_last_comp_alloc_lines   = p_cacnt
        iv_max_last_comp_alloc_lines   = p_cacmax
        iv_max_last_comp_unalloc_count = p_culcnt
        iv_max_last_comp_partial_count = p_cplcnt
        iv_max_last_comp_shortage_cnt  = p_cshcnt
        iv_max_last_age                = p_lage
        iv_max_last_comp_deadline_age  = p_cdag
        iv_max_overdue_mix             = p_odmax
        iv_max_current_deadline_mix    = p_cdmmax
        iv_min_future_deadline_mix     = p_fdmmin
        iv_min_last_comp_demand_count  = p_cdmin
        iv_max_last_comp_demand_count  = p_cdmax

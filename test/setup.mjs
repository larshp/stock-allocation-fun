...
export async function initializeDatabase(abap, schemas, insert) {
  ...
  await database.execute([
    ...
    "INSERT INTO vbak (mandt, vbeln, vbtyp) VALUES ('000', 'EXPIR00001', 'C');",
    "INSERT INTO vbak (mandt, vbeln, vbtyp) VALUES ('000', 'BATCH00001', 'C');",
    "INSERT INTO vbak (mandt, vbeln, vbtyp) VALUES ('000', 'NOUNIT0001', 'C');",

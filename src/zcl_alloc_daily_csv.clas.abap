CLASS zcl_alloc_daily_csv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_alloc_daily_csv IMPLEMENTATION.
  ...
  METHOD build.
    ...
    LOOP AT it_lines INTO DATA(ls_day).
      CLEAR lt_fields.
      APPEND |{ ls_day-run_date }| TO lt_fields.
      APPEND |{ ls_day-lines }| TO lt_fields.
      APPEND |{ ls_day-requested_qty }| TO lt_fields.
      APPEND |{ ls_day-allocated_qty }| TO lt_fields.
      APPEND |{ ls_day-coverage_pct }| TO lt_fields.

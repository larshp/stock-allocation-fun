...
export async function initializeDatabase(abap, schemas, insert) {
  ...
  await database.execute([
    ...
    "INSERT INTO vbap (mandt, vbeln, posnr, matnr, werks, abgru, lifsp, lprio, vrkme) VALUES ('000', 'TXNFAIL0001', '000010', 'MATERIAL-TXN-FAIL', '1000', '', '', '01', 'EA');",
    ...
    "INSERT INTO vbap (mandt, vbeln, posnr, matnr, werks, abgru, lifsp, lprio, vrkme) VALUES ('000', 'MALFORM001', '000000', 'MATERIAL-MALFORMED', '1000', '', '', '01', 'EA');",
    ...
    "INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng) VALUES ('000', 'TXNFAIL0001', '000010', '0001', '20260815', 1, 0);",
    ...
    ,"INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng) VALUES ('000', 'BLKHEAD001', '000010', '0001', '20260815', 2, 0);"
     ...
     ,"INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng) VALUES ('000', 'MALFORM001', '000000', '0000', '20260815', 1, 0);"
  ]);

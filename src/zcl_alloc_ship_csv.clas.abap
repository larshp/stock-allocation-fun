CLASS zcl_alloc_ship_csv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_alloc_ship_csv IMPLEMENTATION.
  ...
  METHOD build.
    ...
    LOOP AT it_lines INTO DATA(ls_ship).
      CLEAR lt_fields.
      APPEND |{ ls_ship-shipment }| TO lt_fields.
      APPEND |{ ls_ship-lgort }| TO lt_fields.
      APPEND |{ ls_ship-positions }| TO lt_fields.
      APPEND |{ ls_ship-quantity }| TO lt_fields.

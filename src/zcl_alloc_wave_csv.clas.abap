CLASS zcl_alloc_wave_csv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_alloc_wave_csv IMPLEMENTATION.
  ...
  METHOD build.
    ...
    LOOP AT it_lines INTO DATA(ls_wave).
      CLEAR lt_fields.
      APPEND |{ ls_wave-wave }| TO lt_fields.
      APPEND |{ ls_wave-index }| TO lt_fields.
      APPEND |{ ls_wave-quantity }| TO lt_fields.

...
export async function initializeDatabase(abap, schemas, insert) {
  ...
  await database.execute([
    ...
    "INSERT INTO vbak (mandt, vbeln, vbtyp, auart, lifsk) VALUES ('000', 'NEGDEMAND01', 'C', 'OR', '');",
    ...
    "INSERT INTO vbak (mandt, vbeln, vbtyp, auart, lifsk) VALUES ('000', 'BATCHZERO1', 'C', 'OR', '');",
    ...
    "INSERT INTO vbak (mandt, vbeln, vbtyp, auart, lifsk) VALUES ('000', 'DELITEM001', 'C', 'OR', '');",
    "INSERT INTO vbak (mandt, vbeln, vbtyp, auart, lifsk) VALUES ('000', 'BADDEL0001', 'C', 'OR', '');",
    ...
    "INSERT INTO vbap (mandt, vbeln, posnr, matnr, werks, abgru, lprio, vrkme) VALUES ('000', 'NEGDEMAND01', '000010', 'MATERIAL-NEGATIVE-DEMAND', '1000', '', '01', 'EA');",
    ...
    "INSERT INTO vbap (mandt, vbeln, posnr, matnr, werks, abgru, lprio, vrkme) VALUES ('000', 'BATCHZERO1', '000010', 'MATERIAL-BATCH', '1000', '', '01', 'EA');",
    ...
    "INSERT INTO vbap (mandt, vbeln, posnr, matnr, werks, abgru, lprio, vrkme, loekz) VALUES ('000', 'DELITEM001', '000010', 'MATERIAL-PRIO', '1000', '', '01', 'EA', 'X');",
    "INSERT INTO vbap (mandt, vbeln, posnr, matnr, werks, abgru, lprio, vrkme, loekz) VALUES ('000', 'BADDEL0001', '000010', 'MATERIAL-BAD-DELETION', '1000', '', '01', 'EA', '?');",
    ...
    "INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng, lifsp) VALUES ('000', 'NEGDEMAND01', '000010', '0001', '20260815', -1, -2, '');",
    ...
    "INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng, lifsp) VALUES ('000', 'BATCHZERO1', '000010', '0001', '20260815', 2, 0, '');",
    ...
    "INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng, lifsp) VALUES ('000', 'DELITEM001', '000010', '0001', '20260815', 2, 0, '');",
    ...
    "INSERT INTO vbep (mandt, vbeln, posnr, etenr, edatu, wmeng, bmeng, lifsp) VALUES ('000', 'BADDEL0001', '000010', '0001', '20260815', 1, 0, '');",
